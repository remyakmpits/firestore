(self["webpackChunkfireBaseChatApp"] = self["webpackChunkfireBaseChatApp"] || []).push([["common"],{
...
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! firebase/app */ 4395);
...
let ChatService = class ChatService {
    ...
    addChatMessage(msg) {
        return this.afs.collection('messages').add({
            ...
            createdAt: firebase_app__WEBPACK_IMPORTED_MODULE_0__.firestore.FieldValue.serverTimestamp()
        });
    }
    getChatMessages() {
        let users = [];
        return this.getUsers().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(res => {
            users = res;
            return this.afs.collection('messages', ref => ref.orderBy('createdAt')).valueChanges({ idField: 'id' });
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(messages => {
